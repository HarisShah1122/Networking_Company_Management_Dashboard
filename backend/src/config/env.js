...
module.exports = {
  ...
  CORS_ORIGIN: process.env.CORS_ORIGIN || ['http://localhost:3000', 'http://localhost:3001', 'http://www.pacetelecomktg.cloud'],
  // Email Configuration
  EMAIL_HOST: process.env.EMAIL_HOST || 'smtp.gmail.com',
  EMAIL_PORT: process.env.EMAIL_PORT || 587,
  EMAIL_SECURE: process.env.EMAIL_SECURE || false,
  EMAIL_USER: process.env.EMAIL_USER || 'masoompesho506@gmail.com',
  EMAIL_PASS: process.env.EMAIL_PASS || '',
  EMAIL_FROM: process.env.EMAIL_FROM || 'Pace Telecom Katlang <masoompesho506@gmail.com>',
