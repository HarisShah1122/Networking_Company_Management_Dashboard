...
module.exports = {
  ...
  DB_PASSWORD: process.env.DB_PASSWORD || 'Root@786',
  ...
  CORS_ORIGIN: process.env.CORS_ORIGIN || (process.env.NODE_ENV === 'production' ? 'https://pace-telecom-management-dashboard.vercel.app' : 'http://localhost:3000'),
};
